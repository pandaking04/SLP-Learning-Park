...
public class ancient_zone_1 extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ancient_zone1);
     ...
     //   id =db.collection("ancient").document().getId();
       ...
       // ar_btn = findViewById(R.id.ar_btn);
        ...
        ancientAdapter = new AncientAdapter(ancient_zone_1.this,itemArrayList);
        ...
        watch_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String url = "https://m.youtube.com/watch?v=-c-HUWkeB5A";
        ...
        back_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(ancient_zone_1.this, ancient_map.class));
            }
        });
...
//            @Override
//            public void onClick(View v) {
//                startActivity(new Intent(ancient_zone_1.this, AR.class));
//            }
//        });
    }
    ...
    private void EventChangeListener(){
        db.collection("museum").document("ancient").collection("zone1")
